	...
	public void loadShortestPathTotalTimeIntegrationTest() {
	 ...
	 public void testmidpoint() {
		 DijkstraGraph<String,Double> graph = new DijkstraGraph<String,Double>(new PlaceholderMap<>());
		    ...
		    File file = new File("C:\\Users\\chrep\\eclipse-workspace\\groupproject\\src\\campus.dot");
		    try {
		    	System.out.println(file);
		    	backend.readFile(file);
		    	List<String> actual =backend.shortestPathMidpoint("Memorial Union", "Union South", "Computer Sciences and Statistics");
		    	System.out.println(graph.computeShortestPath("Memorial Union", "Union South"));
		    	System.out.println(graph.computeShortestPath("Union South", "Computer Sciences and Statistics"));
		    	System.out.println(actual);
		    	String expected = "[Memorial Union, Radio Hall, Education Building, South Hall, Law Building, X01, Luther Memorial Church, Noland Hall, Meiklejohn House, Computer Sciences and Statistics, Union South, Computer Sciences and Statistics]";
		    			assertEquals(expected, actual);
		    }catch( NoSuchElementException e) {
		    	System.out.println(" not a node");
		    	
		    } catch(FileNotFoundException e) {
		    	System.out.println(" not a working file path");
		    }
